...
public class Event implements Comparable<Event> {
    ...
    public String actionId() {
        ...
        if (ActivityTaskScheduled == type()) { return historyEvent.getActivityTaskScheduledEventAttributes().getActivityId(); }
        if (ScheduleActivityTaskFailed == type()) { return historyEvent.getScheduleActivityTaskFailedEventAttributes().getActivityId(); }
        if (ActivityTaskStarted == type()) {
            ...
            return new Event(scheduledEvent.get(), historyEvents).actionId();
        }
        ...
        if (WorkflowExecutionSignaled == type()) { return historyEvent.getWorkflowExecutionSignaledEventAttributes().getSignalName(); }
        if (MarkerRecorded == type()) { return historyEvent.getMarkerRecordedEventAttributes().getMarkerName(); }
        if (RecordMarkerFailed == type()) { return null; }
        if (TimerStarted == type()) { return historyEvent.getTimerStartedEventAttributes().getTimerId(); }
        if (StartTimerFailed == type()) { return historyEvent.getStartTimerFailedEventAttributes().getTimerId(); }
        if (TimerFired == type()) { return historyEvent.getTimerFiredEventAttributes().getTimerId(); }
        if (TimerCanceled == type()) { return historyEvent.getTimerCanceledEventAttributes().getTimerId(); }
        if (CancelTimerFailed == type()) { return historyEvent.getCancelTimerFailedEventAttributes().getTimerId(); }
        ...
        if (SignalExternalWorkflowExecutionInitiated == type()) { return historyEvent.getSignalExternalWorkflowExecutionInitiatedEventAttributes().getSignalName(); }
